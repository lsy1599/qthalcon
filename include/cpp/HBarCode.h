...
public:
  ...
  // 
  virtual HTuple GetBarCodeParamSpecific(const Halcon::HTuple &CodeTypes, const Halcon::HTuple &GenParamName) const;
  // Get parameters that are used by the bar code reader when processing a
  // specific bar code type.
  // 
  virtual HTuple GetBarCodeParamSpecific(const char *CodeTypes, const char *GenParamName) const;
  // Get one or several parameters that describe the bar code model.
  virtual HTuple GetBarCodeParam(const Halcon::HTuple &GenParamName) const;
  // Get one or several parameters that describe the bar code model.
  virtual HTuple GetBarCodeParam(const char *GenParamName) const;
  // Set selected parameters of the bar code model for selected bar code types
  virtual void SetBarCodeParamSpecific(const Halcon::HTuple &CodeTypes, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Set selected parameters of the bar code model.
  virtual void SetBarCodeParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Set selected parameters of the bar code model.
  virtual void SetBarCodeParam(const char *GenParamName, double GenParamValue) const;
  // Create a model of a bar code reader.
  virtual void CreateBarCodeModel(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
  // Create a model of a bar code reader.
  virtual void CreateBarCodeModel(const char *GenParamName, double GenParamValue);
};
