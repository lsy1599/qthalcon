...
public:
  ...
  virtual HTuple GetCameraSetupParam(const Halcon::HTuple &CameraIdx, const Halcon::HTuple &GenParamName) const;
  // Get generic camera setup model parameters.
  virtual HTuple GetCameraSetupParam(Hlong CameraIdx, const char *GenParamName) const;
  // Set generic camera setup model parameters.
  virtual void SetCameraSetupParam(const Halcon::HTuple &CameraIdx, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Set generic camera setup model parameters.
  virtual void SetCameraSetupParam(Hlong CameraIdx, const char *GenParamName, double GenParamValue) const;
