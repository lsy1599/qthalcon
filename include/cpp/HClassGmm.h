...
public:
  ...
  // provided data.
  virtual HTuple SelectFeatureSetGmm(const Halcon::HClassTrainData &ClassTrainDataHandle, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score);
  // Selects an optimal combination from a set of features to classify the 
  // provided data.
  virtual HTuple SelectFeatureSetGmm(const Halcon::HClassTrainData &ClassTrainDataHandle, const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *Score);
  // Create a look-up table using a gaussian mixture model to classify byte
  // images.
  virtual HClassLUT CreateClassLutGmm(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
