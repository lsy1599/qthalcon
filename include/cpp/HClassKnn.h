...
public:
  ...
  virtual HTuple SelectFeatureSetKnn(const Halcon::HClassTrainData &ClassTrainDataHandle, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score);
  // Selects an optimal subset from a set of features to solve a certain 
  // classification problem.
  virtual HTuple SelectFeatureSetKnn(const Halcon::HClassTrainData &ClassTrainDataHandle, const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *Score);
  ...
  virtual HTuple GetParamsClassKnn(const Halcon::HTuple &GenParamName) const;
  // Set parameters for k-NN classification.
  virtual void SetParamsClassKnn(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  ...
  virtual void TrainClassKnn(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  ...
  // images.
  virtual HClassLUT CreateClassLutKnn(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
};
