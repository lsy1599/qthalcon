...
public:
  ...
  // images.
  virtual void CreateClassLutKnn(const Halcon::HClassKnn &KNNHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
  // Create a look-up table using a gaussian mixture model to classify byte
  // images.
  virtual void CreateClassLutGmm(const Halcon::HClassGmm &GMMHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
  // Create a look-up table using a Support-Vector-Machine to classify byte
  // images.
  virtual void CreateClassLutSvm(const Halcon::HClassSvm &SVMHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
  // Create a look-up table using a multi-layer perceptron to classify byte
  // images.
  virtual void CreateClassLutMlp(const Halcon::HClassMlp &MLPHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
};
