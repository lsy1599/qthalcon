...
public:
  ...
  virtual HTuple SelectFeatureSetMlp(const Halcon::HClassTrainData &ClassTrainDataHandle, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score);
  // Selects an optimal combination of features to classify the provided data.
  virtual HTuple SelectFeatureSetMlp(const Halcon::HClassTrainData &ClassTrainDataHandle, const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *Score);
  // Create a look-up table using a multi-layer perceptron to classify byte
  // images.
  virtual HClassLUT CreateClassLutMlp(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
