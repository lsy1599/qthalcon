...
public:
  ...
  virtual HTuple SelectFeatureSetSvm(const Halcon::HClassTrainData &ClassTrainDataHandle, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score);
  // Selects an optimal combination of features to classify the provided data.
  virtual HTuple SelectFeatureSetSvm(const Halcon::HClassTrainData &ClassTrainDataHandle, const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *Score);
  // Create a look-up table using a Support-Vector-Machine to classify byte
  // images.
  virtual HClassLUT CreateClassLutSvm(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
