...
public:
  ...
  virtual HClassMlp SelectFeatureSetMlp(const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score) const;
  // Selects an optimal combination of features to classify the provided data.
  virtual HClassMlp SelectFeatureSetMlp(const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score) const;
  // Selects an optimal combination of features to classify the provided data.
  virtual HClassSvm SelectFeatureSetSvm(const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score) const;
  // Selects an optimal combination of features to classify the provided data.
  virtual HClassSvm SelectFeatureSetSvm(const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score) const;
  // Selects an optimal combination from a set of features to classify the 
  // provided data.
  virtual HClassGmm SelectFeatureSetGmm(const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score) const;
  // Selects an optimal combination from a set of features to classify the 
  // provided data.
  virtual HClassGmm SelectFeatureSetGmm(const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score) const;
  // Selects an optimal subset from a set of features to solve a certain 
  // classification problem.
  virtual HClassKnn SelectFeatureSetKnn(const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score) const;
  // Selects an optimal subset from a set of features to solve a certain 
  // classification problem.
  virtual HClassKnn SelectFeatureSetKnn(const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score) const;
};
