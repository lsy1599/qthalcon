 ...
 *
 * (c) 2009-2017 by MVTec Software GmbH
 *                  www.mvtec.com
 * 
 *****************************************************************************
 *
...
public:
  ...
  virtual HTuple GetComputeDeviceParam(const Halcon::HTuple &GenParamName) const;
  // Query compute device parameters.
  virtual HTuple GetComputeDeviceParam(const char *GenParamName) const;
  // Set parameters of an compute device.
  virtual void SetComputeDeviceParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
