...
public:
  ...
  virtual HXLDContArray FindDataCode2d(const HImage &Image, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ResultHandles, Halcon::HTuple *DecodedDataStrings) const;
  // Detect and read 2D data code symbols in an image or
  // train the 2D data code model.
  virtual HXLDContArray FindDataCode2d(const HImage &Image, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ResultHandles, char *DecodedDataStrings) const;
  // Detect and read 2D data code symbols in an image or
  // train the 2D data code model.
  virtual HXLDContArray FindDataCode2d(const HImage &Image, const char *GenParamName, Hlong GenParamValue, Halcon::HTuple *ResultHandles, Halcon::HTuple *DecodedDataStrings) const;
  // Detect and read 2D data code symbols in an image or
  // train the 2D data code model.
  virtual HXLDContArray FindDataCode2d(const HImage &Image, const char *GenParamName, Hlong GenParamValue, Hlong *ResultHandles, char *DecodedDataStrings) const;
  // Set selected parameters of the 2D data code model.
  virtual void SetDataCode2dParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Get one or several parameters that describe the 2D data code model.
  virtual HTuple GetDataCode2dParam(const Halcon::HTuple &GenParamName) const;
  // Get one or several parameters that describe the 2D data code model.
  virtual HTuple GetDataCode2dParam(const char *GenParamName) const;
  ...
  virtual void CreateDataCode2dModel(const Halcon::HTuple &SymbolType, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
};
