...
public:
  ...
  virtual void SetDeformableModelParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Return the parameters of a deformable model.
  virtual HTuple GetDeformableModelParams(const Halcon::HTuple &GenParamName) const;
  // Return the parameters of a deformable model.
  virtual HTuple GetDeformableModelParams(const char *GenParamName) const;
  ...
  virtual HImageArray FindLocalDeformableModel(const HImage &Image, HImage *VectorField, HXLDContArray *DeformedContours, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &ResultType, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Halcon::HTuple *Row, Halcon::HTuple *Column) const;
  // Find the best matches of a calibrated deformable model in an image and return
  // their 3D pose.
  virtual HTuple FindPlanarCalibDeformableModel(const HImage &Image, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *CovPose, Halcon::HTuple *Score) const;
  // Find the best matches of a planar projective invariant deformable model
  // in an image.
  virtual HTuple FindPlanarUncalibDeformableModel(const HImage &Image, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score) const;
