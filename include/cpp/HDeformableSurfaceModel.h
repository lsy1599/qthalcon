...
public:
  ...
  virtual HTuple GetDeformableSurfaceModelParam(const Halcon::HTuple &GenParamName) const;
  // Return the parameters and properties of a deformable surface model.
  virtual HTuple GetDeformableSurfaceModelParam(const char *GenParamName) const;
