...
public:
  ...
  virtual void SetIoChannelParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Query specific parameters of I/O channels.
  virtual HTuple GetIoChannelParam(const Halcon::HTuple &GenParamName) const;
  // Query specific parameters of I/O channels.
  virtual HTuple GetIoChannelParam(const char *GenParamName) const;
