...
public:
  ...
  virtual void SetIoDeviceParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Query settings of an I/O device instance.
  // 
  virtual HTuple GetIoDeviceParam(const Halcon::HTuple &GenParamName) const;
  // Query settings of an I/O device instance.
  // 
  virtual HTuple GetIoDeviceParam(const char *GenParamName) const;
