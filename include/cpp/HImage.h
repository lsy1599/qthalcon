...
public:
  ...
  // system.
  virtual HImage DisparityImageToXyz(HImage *Y, HImage *Z, const Halcon::HTuple &CamParamRect1, const Halcon::HTuple &CamParamRect2, const Halcon::HTuple &RelPoseRect) const;
  ...
  virtual HTuple DetermineDeformableModelParams(const Halcon::HTuple &NumLevels, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleMin, const Halcon::HTuple &ScaleMax, const Halcon::HTuple &Optimization, const Halcon::HTuple &Metric, const Halcon::HTuple &Contrast, const Halcon::HTuple &MinContrast, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, const Halcon::HTuple &Parameters, Halcon::HTuple *ParameterValue) const;
  // Find the best matches of a local deformable model in an image.
  virtual HImageArray FindLocalDeformableModel(HImageArray *VectorField, HXLDContArray *DeformedContours, const Halcon::HDeformableModel &ModelID, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &ResultType, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Halcon::HTuple *Row, Halcon::HTuple *Column) const;
  // Find the best matches of a calibrated deformable model in an image and return
  // their 3D pose.
  virtual HTuple FindPlanarCalibDeformableModel(const Halcon::HDeformableModel &ModelID, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *CovPose, Halcon::HTuple *Score) const;
  // Find the best matches of a planar projective invariant deformable model
  // in an image.
  virtual HTuple FindPlanarUncalibDeformableModel(const Halcon::HDeformableModel &ModelID, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score) const;
  ...
  virtual HTuple FindShapeModel3d(const Halcon::HShapeModel3D &ShapeModel3DID, const Halcon::HTuple &MinScore, const Halcon::HTuple &Greediness, const Halcon::HTuple &NumLevels, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *CovPose, Halcon::HTuple *Score) const;
  ...
  virtual HXLDContArray FindDataCode2d(const Halcon::HDataCode2D &DataCodeHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ResultHandles, Halcon::HTuple *DecodedDataStrings) const;
  // Detect and read 2D data code symbols in an image or
  // train the 2D data code model.
  virtual HXLDContArray FindDataCode2d(const Halcon::HDataCode2D &DataCodeHandle, const char *GenParamName, Hlong GenParamValue, Halcon::HTuple *ResultHandles, Halcon::HTuple *DecodedDataStrings) const;
  ...
  virtual Hlong AddTextureInspectionModelImage(const Halcon::HTextureInspectionModel &TextureInspectionModel) const;
  // bilateral filtering of an image.
  virtual HImage BilateralFilter(const HImage &ImageJoint, const Halcon::HTuple &SigmaSpatial, const Halcon::HTuple &SigmaRange, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // bilateral filtering of an image.
  virtual HImage BilateralFilter(const HImage &ImageJoint, double SigmaSpatial, double SigmaRange, const char *GenParamName, double GenParamValue) const;
  // bilateral filtering of an image.
  virtual HImage BilateralFilter(const HImageArray &ImageJoint, const Halcon::HTuple &SigmaSpatial, const Halcon::HTuple &SigmaRange, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // bilateral filtering of an image.
  virtual HImage BilateralFilter(const HImageArray &ImageJoint, double SigmaSpatial, double SigmaRange, const char *GenParamName, double GenParamValue) const;
  // Find the best matches of multiple NCC models.
  virtual HTuple FindNccModels(const Halcon::HTuple &ModelIDs, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &SubPixel, const Halcon::HTuple &NumLevels, Halcon::HTuple *Column, Halcon::HTuple *Angle, Halcon::HTuple *Score, Halcon::HTuple *Model) const;
  // Find the best matches of multiple NCC models.
  virtual HTuple FindNccModels(Hlong ModelIDs, double AngleStart, double AngleExtent, double MinScore, Hlong NumMatches, double MaxOverlap, const char *SubPixel, Hlong NumLevels, Halcon::HTuple *Column, Halcon::HTuple *Angle, Halcon::HTuple *Score, Halcon::HTuple *Model) const;
  // Guided filtering of an image.
  virtual HImage GuidedFilter(const HImage &ImageGuide, const Halcon::HTuple &Radius, const Halcon::HTuple &Amplitude) const;
  // Guided filtering of an image.
  virtual HImage GuidedFilter(const HImage &ImageGuide, Hlong Radius, double Amplitude) const;
  // Guided filtering of an image.
  virtual HImage GuidedFilter(const HImageArray &ImageGuide, const Halcon::HTuple &Radius, const Halcon::HTuple &Amplitude) const;
  // Guided filtering of an image.
  virtual HImage GuidedFilter(const HImageArray &ImageGuide, Hlong Radius, double Amplitude) const;
  // Create an interleaved image from a multichannel image.
  virtual HImage InterleaveChannels(const Halcon::HTuple &PixelFormat, const Halcon::HTuple &RowBytes, const Halcon::HTuple &Alpha) const;
  // Segment image using Maximally Stable Extremal Regions (MSER).
  virtual HRegionArray SegmentImageMser(HRegionArray *MSERLight, const Halcon::HTuple &Polarity, const Halcon::HTuple &MinArea, const Halcon::HTuple &MaxArea, const Halcon::HTuple &Delta, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
};
