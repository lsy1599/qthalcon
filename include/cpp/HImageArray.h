...
public:
  ...
  // system.
  virtual HImageArray DisparityImageToXyz(HImageArray *Y, HImageArray *Z, const Halcon::HTuple &CamParamRect1, const Halcon::HTuple &CamParamRect2, const Halcon::HTuple &RelPoseRect) const;
  ...
  virtual HTuple AddTextureInspectionModelImage(const Halcon::HTextureInspectionModel &TextureInspectionModel) const;
  // Inspection of the texture within an image.
  virtual HRegionArray ApplyTextureInspectionModel(const Halcon::HTextureInspectionModel &TextureInspectionModel, Halcon::HTextureInspectionResult *TextureInspectionResultID) const;
  // bilateral filtering of an image.
  virtual HImageArray BilateralFilter(const HImageArray &ImageJoint, const Halcon::HTuple &SigmaSpatial, const Halcon::HTuple &SigmaRange, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // bilateral filtering of an image.
  virtual HImageArray BilateralFilter(const HImageArray &ImageJoint, double SigmaSpatial, double SigmaRange, const char *GenParamName, double GenParamValue) const;
  ...
  virtual HImageArray GuidedFilter(const HImageArray &ImageGuide, const Halcon::HTuple &Radius, const Halcon::HTuple &Amplitude) const;
  // Guided filtering of an image.
  virtual HImageArray GuidedFilter(const HImageArray &ImageGuide, Hlong Radius, double Amplitude) const;
};
