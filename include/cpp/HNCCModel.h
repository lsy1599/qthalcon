...
public:
  ...
  virtual void SetNccModelParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  ...
  virtual HTuple FindNccModels(const HImageArray &Image, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &SubPixel, const Halcon::HTuple &NumLevels, Halcon::HTuple *Column, Halcon::HTuple *Angle, Halcon::HTuple *Score, Halcon::HTuple *Model) const;
  // Find the best matches of multiple NCC models.
  virtual HTuple FindNccModels(const HImageArray &Image, double AngleStart, double AngleExtent, double MinScore, Hlong NumMatches, double MaxOverlap, const char *SubPixel, Hlong NumLevels, Halcon::HTuple *Column, Halcon::HTuple *Angle, Halcon::HTuple *Score, Halcon::HTuple *Model) const;
  // Return the region used to create an NCC model.
  virtual HRegion GetNccModelRegion() const;
};
