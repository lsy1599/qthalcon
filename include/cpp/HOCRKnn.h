...
public:
  ...
  virtual void CreateOcrClassKnn(const Halcon::HTuple &WidthCharacter, const Halcon::HTuple &HeightCharacter, const Halcon::HTuple &Interpolation, const Halcon::HTuple &Features, const Halcon::HTuple &Characters, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
  // Trains an k-NN classifier for an OCR task.
  virtual void TrainfOcrClassKnn(const Halcon::HTuple &TrainingFile, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  ...
  virtual HTuple SelectFeatureSetTrainfKnn(const Halcon::HTuple &TrainingFile, const Halcon::HTuple &FeatureList, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score);
};
