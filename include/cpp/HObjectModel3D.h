 ...
 *
 * (c) 2007-2017 by MVTec Software GmbH
 *                  www.mvtec.com
 * 
 *****************************************************************************
 *
...
public:
  ...
  virtual HTuple FitPrimitivesObjectModel3d(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Segment a set of 3D points into sub-sets with similar characteristics.
  virtual HTuple SegmentObjectModel3d(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  ...
  // 3D object model.
  virtual void DistanceObjectModel3d(const Halcon::HObjectModel3D &ObjectModel3DTo, const Halcon::HTuple &Pose, const Halcon::HTuple &MaxDistance, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  ...
  virtual HTuple GetObjectModel3dParams(const Halcon::HTuple &GenParamName) const;
  ...
  virtual HObjectModel3D EdgesObjectModel3d(const Halcon::HTuple &MinAmplitude, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Find edges in a 3D object model.
  virtual HObjectModel3D EdgesObjectModel3d(double MinAmplitude, const char *GenParamName, double GenParamValue) const;
  // Find the best matches of a surface model in a 3D scene and images.
  virtual HTuple FindSurfaceModelImage(const HImageArray &Image, const Halcon::HSurfaceModel &SurfaceModelID, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &KeyPointFraction, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Halcon::HTuple *SurfaceMatchingResultID) const;
  // Find the best matches of a surface model in a 3D scene and images.
  virtual HTuple FindSurfaceModelImage(const HImageArray &Image, const Halcon::HSurfaceModel &SurfaceModelID, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &KeyPointFraction, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Hlong *SurfaceMatchingResultID) const;
  // Refine the pose of a surface model in a 3D scene and in images.
  virtual HTuple RefineSurfaceModelPoseImage(const HImageArray &Image, const Halcon::HSurfaceModel &SurfaceModelID, const Halcon::HTuple &InitialPose, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Halcon::HTuple *SurfaceMatchingResultID) const;
  // Refine the pose of a surface model in a 3D scene and in images.
  virtual HTuple RefineSurfaceModelPoseImage(const HImageArray &Image, const Halcon::HSurfaceModel &SurfaceModelID, const Halcon::HTuple &InitialPose, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Hlong *SurfaceMatchingResultID) const;
};
