...
public:
  ...
  // technique.
  virtual HSheetOfLightModel CreateSheetOfLightModel(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Create a model to perform 3D-measurements using the sheet-of-light
  // technique.
  virtual HSheetOfLightModel CreateSheetOfLightModel(const char *GenParamName, Hlong GenParamValue) const;
  ...
  virtual HTuple DoOcrMultiClassCnn(const HImage &Image, const Halcon::HOCRCnn &OCRHandle, double *Confidence) const;
  // Classify a single character with an CNN-based OCR classifier.
  virtual HTuple DoOcrSingleClassCnn(const HImage &Image, const Halcon::HOCRCnn &OCRHandle, const Halcon::HTuple &Num, Halcon::HTuple *Confidence) const;
  // Classify a related group of characters with an CNN-based OCR classifier.
  virtual HTuple DoOcrWordCnn(const HImage &Image, const Halcon::HOCRCnn &OCRHandle, const Halcon::HTuple &Expression, const Halcon::HTuple &NumAlternatives, const Halcon::HTuple &NumCorrections, double *Confidence, char *Word, double *Score) const;
  // Classify a related group of characters with an CNN-based OCR classifier.
  virtual HTuple DoOcrWordCnn(const HImage &Image, const Halcon::HOCRCnn &OCRHandle, const char *Expression, Hlong NumAlternatives, Hlong NumCorrections, double *Confidence, char *Word, double *Score) const;
};
