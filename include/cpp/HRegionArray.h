...
public:
  ...
  virtual HTuple DoOcrMultiClassCnn(const HImage &Image, const Halcon::HOCRCnn &OCRHandle, Halcon::HTuple *Confidence) const;
  // Classify a related group of characters with an CNN-based OCR classifier.
  virtual HTuple DoOcrWordCnn(const HImage &Image, const Halcon::HOCRCnn &OCRHandle, const Halcon::HTuple &Expression, const Halcon::HTuple &NumAlternatives, const Halcon::HTuple &NumCorrections, Halcon::HTuple *Confidence, Halcon::HTuple *Word, Halcon::HTuple *Score) const;
  // Classify a related group of characters with an CNN-based OCR classifier.
  virtual HTuple DoOcrWordCnn(const HImage &Image, const Halcon::HOCRCnn &OCRHandle, const char *Expression, Hlong NumAlternatives, Hlong NumCorrections, Halcon::HTuple *Confidence, Halcon::HTuple *Word, Halcon::HTuple *Score) const;
};
