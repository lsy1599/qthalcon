...
public:
  ...
  virtual double GetSampleIdentifierParam(const Halcon::HTuple &GenParamName) const;
  // Get selected parameters of a sample identifier.
  virtual double GetSampleIdentifierParam(const char *GenParamName) const;
  // Set selected parameters of a sample identifier.
  virtual void SetSampleIdentifierParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Set selected parameters of a sample identifier.
  virtual void SetSampleIdentifierParam(const char *GenParamName, double GenParamValue) const;
  ...
  virtual void TrainSampleIdentifier(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  ...
  virtual void CreateSampleIdentifier(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
};
