...
public:
  ...
  virtual void CreateScatteredDataInterpolator(const Halcon::HTuple &Method, const Halcon::HTuple &Rows, const Halcon::HTuple &Columns, const Halcon::HTuple &Values, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
};
