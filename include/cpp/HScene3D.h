...
public:
  ...
  virtual Hlong AddScene3dLabel(const Halcon::HTuple &Text, const Halcon::HTuple &ReferencePoint, const Halcon::HTuple &Position, const Halcon::HTuple &RelatesTo) const;
  // Remove a text label from a 3D scene.
  virtual void RemoveScene3dLabel(const Halcon::HTuple &LabelIndex) const;
  // Remove a text label from a 3D scene.
  virtual void RemoveScene3dLabel(Hlong LabelIndex) const;
  // Set parameters of a text label in a 3D scene.
  virtual void SetScene3dLabelParam(const Halcon::HTuple &LabelIndex, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
};
