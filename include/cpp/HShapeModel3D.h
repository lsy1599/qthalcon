...
public:
  ...
  virtual HTuple GetShapeModel3dParams(const Halcon::HTuple &GenParamName) const;
  // Return the parameters of a 3D shape model.
  virtual HTuple GetShapeModel3dParams(const char *GenParamName) const;
  // Find the best matches of a 3D shape model in an image.
  virtual HTuple FindShapeModel3d(const HImage &Image, const Halcon::HTuple &MinScore, const Halcon::HTuple &Greediness, const Halcon::HTuple &NumLevels, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *CovPose, Halcon::HTuple *Score) const;
  // Prepare a 3D object model for matching.
  virtual void CreateShapeModel3d(const Halcon::HObjectModel3D &ObjectModel3D, const Halcon::HTuple &CamParam, const Halcon::HTuple &RefRotX, const Halcon::HTuple &RefRotY, const Halcon::HTuple &RefRotZ, const Halcon::HTuple &OrderOfRotation, const Halcon::HTuple &LongitudeMin, const Halcon::HTuple &LongitudeMax, const Halcon::HTuple &LatitudeMin, const Halcon::HTuple &LatitudeMax, const Halcon::HTuple &CamRollMin, const Halcon::HTuple &CamRollMax, const Halcon::HTuple &DistMin, const Halcon::HTuple &DistMax, const Halcon::HTuple &MinContrast, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
};
