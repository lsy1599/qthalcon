...
public:
  ...
  // technique.
  virtual void CreateSheetOfLightModel(const HRegion &ProfileRegion, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
  // Create a model to perform 3D-measurements using the sheet-of-light
  // technique.
  virtual void CreateSheetOfLightModel(const HRegion &ProfileRegion, const char *GenParamName, Hlong GenParamValue);
};
