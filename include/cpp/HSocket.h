...
public:
  ...
  virtual HTuple GetSocketParam(const Halcon::HTuple &GenParamName) const;
  // Get the value of a socket parameter.
  virtual HTuple GetSocketParam(const char *GenParamName) const;
  // Set a socket parameter.
  virtual void SetSocketParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
