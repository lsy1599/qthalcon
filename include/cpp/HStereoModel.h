...
public:
  ...
  virtual HTuple GetStereoModelParam(const Halcon::HTuple &GenParamName) const;
  // Get stereo model parameters.
  virtual HTuple GetStereoModelParam(const char *GenParamName) const;
  // Set stereo model parameters.
  virtual void SetStereoModelParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  ...
  virtual HObjectModel3D GetStereoModelObjectModel3d(const Halcon::HTuple &GenParamName) const;
  // Get intermediate 3D object model of a stereo reconstruction
  virtual HObjectModel3D GetStereoModelObjectModel3d(const char *GenParamName) const;
};
