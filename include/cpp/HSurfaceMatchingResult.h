...
public:
  ...
  virtual HTuple FindSurfaceModelImage(const HImageArray &Image, const Halcon::HSurfaceModel &SurfaceModelID, const Halcon::HObjectModel3D &ObjectModel3D, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &KeyPointFraction, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score);
  // Refine the pose of a surface model in a 3D scene and in images.
  virtual HTuple RefineSurfaceModelPoseImage(const HImageArray &Image, const Halcon::HSurfaceModel &SurfaceModelID, const Halcon::HObjectModel3D &ObjectModel3D, const Halcon::HTuple &InitialPose, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score);
};
