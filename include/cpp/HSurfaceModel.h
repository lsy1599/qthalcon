...
public:
  ...
  virtual HTuple GetSurfaceModelParam(const Halcon::HTuple &GenParamName) const;
  // Return the parameters and properties of a surface model.
  virtual HTuple GetSurfaceModelParam(const char *GenParamName) const;
  ...
  virtual HTuple FindSurfaceModelImage(const HImageArray &Image, const Halcon::HObjectModel3D &ObjectModel3D, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &KeyPointFraction, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Halcon::HTuple *SurfaceMatchingResultID) const;
  // Find the best matches of a surface model in a 3D scene and images.
  virtual HTuple FindSurfaceModelImage(const HImageArray &Image, const Halcon::HObjectModel3D &ObjectModel3D, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &KeyPointFraction, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Hlong *SurfaceMatchingResultID) const;
  // Refine the pose of a surface model in a 3D scene and in images.
  virtual HTuple RefineSurfaceModelPoseImage(const HImageArray &Image, const Halcon::HObjectModel3D &ObjectModel3D, const Halcon::HTuple &InitialPose, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Halcon::HTuple *SurfaceMatchingResultID) const;
  // Refine the pose of a surface model in a 3D scene and in images.
  virtual HTuple RefineSurfaceModelPoseImage(const HImageArray &Image, const Halcon::HObjectModel3D &ObjectModel3D, const Halcon::HTuple &InitialPose, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Hlong *SurfaceMatchingResultID) const;
  // Set parameters and properties of a surface model.
  virtual void SetSurfaceModelParam(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Set parameters and properties of a surface model.
  virtual void SetSurfaceModelParam(const char *GenParamName, double GenParamValue) const;
};
