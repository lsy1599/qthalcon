...
public:
  ...
  virtual void DispText(const Halcon::HTuple &String, const Halcon::HTuple &CoordSystem, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Color, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue) const;
  // Flush the contents of a window.
  virtual void FlushBuffer() const;
  // Get the current color in RGBA-coding.
  virtual HTuple GetRgba(Halcon::HTuple *Green, Halcon::HTuple *Blue, Halcon::HTuple *Alpha) const;
  // Send an event to a buffer window signaling a mouse double click event.
  virtual HTuple SendMouseDoubleClickEvent(const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button) const;
  // Send an event to a buffer window signaling a mouse double click event.
  virtual HTuple SendMouseDoubleClickEvent(Hlong Row, Hlong Column, Hlong Button) const;
  // Send an event to a window buffer signaling a mouse down event.
  virtual HTuple SendMouseDownEvent(const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button) const;
  // Send an event to a window buffer signaling a mouse down event.
  virtual HTuple SendMouseDownEvent(Hlong Row, Hlong Column, Hlong Button) const;
  // Send an event to a buffer window signaling a mouse drag event.
  virtual HTuple SendMouseDragEvent(const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button) const;
  // Send an event to a buffer window signaling a mouse drag event.
  virtual HTuple SendMouseDragEvent(Hlong Row, Hlong Column, Hlong Button) const;
  // Send an event to a buffer window signaling a mouse up event.
  virtual HTuple SendMouseUpEvent(const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button) const;
  // Send an event to a buffer window signaling a mouse up event.
  virtual HTuple SendMouseUpEvent(Hlong Row, Hlong Column, Hlong Button) const;
  // Sets the callback for content updates in buffer window.
  virtual void SetContentUpdateCallback(const Halcon::HTuple &CallbackFunction, const Halcon::HTuple &CallbackContext) const;
  // Sets the callback for content updates in buffer window.
  virtual void SetContentUpdateCallback(Hlong CallbackFunction, Hlong CallbackContext) const;
  // Set the color definition via RGBA values.
  virtual void SetRgba(const Halcon::HTuple &Red, const Halcon::HTuple &Green, const Halcon::HTuple &Blue, const Halcon::HTuple &Alpha) const;
  // Set the color definition via RGBA values.
  virtual void SetRgba(Hlong Red, Hlong Green, Hlong Blue, Hlong Alpha) const;
};
