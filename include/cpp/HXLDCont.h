...
public:
  ...
  static HXLDCont ReadContourXldDxf(const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, char *DxfStatus);
  // Read XLD contours from a DXF file.
  static HXLDCont ReadContourXldDxf(const char *FileName, const char *GenParamName, double GenParamValue, char *DxfStatus);
