...
public:
  ...
  static HXLDContArray ReadContourXldDxf(const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *DxfStatus);
  // Read XLD contours from a DXF file.
  static HXLDContArray ReadContourXldDxf(const char *FileName, const char *GenParamName, double GenParamValue, Halcon::HTuple *DxfStatus);
