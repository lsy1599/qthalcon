...
public:
  ...
  static HXLDPoly ReadPolygonXldDxf(const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, char *DxfStatus);
  // Read XLD polygons from a DXF file.
  static HXLDPoly ReadPolygonXldDxf(const char *FileName, const char *GenParamName, double GenParamValue, char *DxfStatus);
