...
public:
  ...
  static HXLDPolyArray ReadPolygonXldDxf(const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *DxfStatus);
  // Read XLD polygons from a DXF file.
  static HXLDPolyArray ReadPolygonXldDxf(const char *FileName, const char *GenParamName, double GenParamValue, Halcon::HTuple *DxfStatus);
