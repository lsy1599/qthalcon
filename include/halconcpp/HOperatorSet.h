...
LIntExport void GetParamsOcrClassCnn(const HTuple& OCRHandle, const HTuple& GenParamNames, HTuple* GenParamValues);
...
LIntExport void QueryParamsOcrClassCnn(const HTuple& OCRHandle, HTuple* GenParamNames);
