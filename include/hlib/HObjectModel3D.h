 ...
 * are NOT initialized and must be filled by the caller. */
 ...
 * are valid. The points are copied into the 3D object model. */
 ...
 * object model. The points are copied into the 3D object model. */
